...
<tr>
	...
	<input name="scroll_no[]" type="hidden" value="<?php echo $scholar_no; ?>" />
    <td><?php echo $scholar_no; ?></td>
    <td><input name="name[]" readonly type="text" class="form-control input-medium" value="<?php echo $fnamee; ?>" /></td>
    <td><input name="roll_no[]" id="roll_no<?php echo $x; ?>" type="text" class="form-control input-xsmall" value="<?php echo $roll_noo; ?>" /></td>
    <td><input  name="dob[]" type="text" readonly class="form-control input-small" value="<?php echo $dob; ?>" /></td>
    <!--<td><?php echo $cls; ?></td>-->
    <td>
...
<tr>
    ...
    <td><input  name="dob[]" readonly type="text" class="form-control input-small" value="<?php echo $dob; ?>" /></td>
    <!--<td><?php echo $cls; ?></td>-->
